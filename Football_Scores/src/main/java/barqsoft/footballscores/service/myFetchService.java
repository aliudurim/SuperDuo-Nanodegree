...
import barqsoft.footballscores.widget.MyWidgetIntentReceiver;
...
public class myFetchService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        boolean updateWidget = intent.getBooleanExtra("widgetUpdate", false);
        if (updateWidget) {
            Intent service_start = new Intent(myFetchService.this, MyWidgetIntentReceiver.class);
            service_start.putExtra("widgetUpdated", true);
            service_start.putExtra("widgetUpdateResult", JSON_data);
    ...
    private void getData(String timeFrame) {
        ...
        System.out.println("URl: " + fetch_build);
